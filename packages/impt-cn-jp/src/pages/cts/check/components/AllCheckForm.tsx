...
const inputItems = [
  // { no: 2, limit: 11, name: 'ID', holder: '申告等番号' },
  // { no: 4, limit: 1, name: 'ICB', holder: '申告等種別コード' },
  // { no: 5, limit: 1, name: 'IC1', holder: '申告先種別コード' },
  // { no: 6, limit: 1, name: 'IC2', holder: '申告貨物識別' },
  { no: 7, limit: 1, name: 'SKB', holder: '識別符号' },
  // { no: 8, limit: 2, name: 'CH', holder: 'あて先官署コード' },
  // { no: 9, limit: 2, name: 'CHB', holder: 'あて先部門コード' },
  { no: 10, limit: 2, name: 'CHH', holder: '特例申告あて先官署 コード ' },
  { no: 11, limit: 2, name: 'CHT', holder: '特例申告あて先部門 コード' },
  // { no: 12, limit: 8, name: 'ICD', holder: '申告等予定年月日' },
  ...
  // { no: 24, limit: 5, name: 'ST', holder: '通関予定蔵置場コー ド' },
  ...
  { no: 50, limit: 3, name: 'BOK', holder: '貿易形態別符号' },
  // { no: 51, limit: 3, name: 'COC', holder: 'コンテナ扱い本数' },
  { no: 52, limit: 1, name: 'RTD', holder: '戻税申告識別' },
  { no: 53, limit: 1, name: 'WU', holder: '輸入貿易管理令第３ 条等識別' },
  ...
  { no: 67, limit: 1, name: 'IP1', holder: 'インボイス価格区分 コード' },
  { no: 68, limit: 3, name: 'IP2', holder: 'インボイス価格条件 コード' },
  { no: 69, limit: 3, name: 'IP3', holder: 'インボイス通貨コー ド ' },
  { no: 70, limit: 18, name: 'IP4', holder: 'インボイス価格' },
  { no: 71, limit: 1, name: 'FR1', holder: '運賃区分コード' },
  { no: 72, limit: 3, name: 'FR2', holder: '運賃通貨コード' },
  { no: 73, limit: 16, name: 'FR3', holder: '運賃' },
  { no: 74, limit: 1, name: 'IN1', holder: '保険区分コード' },
  { no: 75, limit: 3, name: 'IN2', holder: '保険通貨コード' },
  { no: 76, limit: 14, name: 'IN3', holder: '保険金額' },
  ...
  { no: 81, limit: 3, name: 'VL2', holder: '評価補正基礎額通貨 コード ' },
  { no: 82, limit: 18, name: 'VL3', holder: '評価補正基礎額' },
  { no: 83, limit: 11, name: 'VL4', holder: '評価補正補正式' },
  { no: 84, limit: 7, name: 'JKH_', holder: '事前教示（評価） ' },
  { no: 85, limit: 18, name: 'TP', holder: '課税価格按分係数合 計' },
  { no: 86, limit: 8, name: 'ISD', holder: '最初蔵入等承認年月 日' },
  { no: 87, limit: 5, name: 'SMC', holder: '蔵入等先保税地域 コード' },
  ...
  { no: 96, limit: 20, name: 'NSC', holder: '荷主セクションコー ド ' },
  { no: 97, limit: 35, name: 'NRN', holder: '荷主リファレンスナ ンバー ' },
...
const manifestItems = [
  ...
  { no: 6, limit: 2, name: 'CH', holder: 'あて先官署コード' },
  { no: 7, limit: 2, name: 'CHB', holder: 'あて先部門コード' },
  { no: 8, limit: 8, name: 'ICD', holder: '申告予定年月日' },
  ...
  { no: 17, limit: 105, name: 'IAD_Add5', holder: '輸入者住所' },
