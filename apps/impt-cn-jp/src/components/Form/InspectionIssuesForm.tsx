...
export interface InspectionIssuesFormProps
  extends useSKForm.SKFormProps<DataSource> {}

const InspectionIssuesForm: React.FC<InspectionIssuesFormProps> = (props) => {
  ...
  return (
    <Modal {...modalProps} width={1200} style={{ marginTop: '15vh' }}>
      <Form name="InspectionIssuesForm" {...formItemLayout} {...formProps}>
...
export default InspectionIssuesForm;
